...
class AppThemeScreen {
  ...
  static final ThemeData lightTheme = ThemeData(
    ...
    textTheme: const TextTheme(
      ...
      titleLarge: TextStyle(color: AppColors.primaryLightTextColor, fontSize: 15),
      titleMedium: TextStyle(color: AppColors.primaryLightTextColor, fontSize: 13),
      titleSmall: TextStyle(color: AppColors.primaryLightTextColor, fontSize: 11),
  ...
  static final ThemeData darkTheme = ThemeData(
    ...
    textTheme: TextTheme(
      ...
      titleLarge: TextStyle(color: AppColors.primaryDarkTextColor, fontSize: 15),
      titleMedium: TextStyle(color: AppColors.primaryDarkTextColor, fontSize: 13),
      titleSmall: TextStyle(color: AppColors.primaryDarkTextColor, fontSize: 11),
